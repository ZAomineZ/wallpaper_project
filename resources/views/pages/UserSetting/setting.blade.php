        ...
        <div class="panel panel-primary" style="margin-top: 25px">
            <div class="panel-heading">
                ...
                <div class="" style="text-align: right; margin-top: -20px">
                    @if(isset($user->users_id))
                        {!! Form::open(['method' => 'POST', 'url' => route('follow' , ['id' => $user->users_id])]) !!}
                        @else
                        {!! Form::open(['method' => 'POST', 'url' => route('follow' , ['id' => $user->id])]) !!}
                    @endif
                    @if(isset($follow))
                            {!! Form::button('Se désabonner', ['class' => 'btn btn-danger', 'type' => 'submit', 'name' => 'follow']) !!}
                        @else
                            {!! Form::button('Suivre', ['class' => 'btn btn-success', 'type' => 'submit', 'name' => 'follow']) !!}
                        @endif
                    {!! Form::close() !!}
                </div>
            </div>
